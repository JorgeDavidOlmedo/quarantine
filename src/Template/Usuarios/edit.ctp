        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-3">
                    <?=$this->Form->input('email',array('class'=>'form-control','autocomplete'=>"off",'required',
                        'autofocus',
                        'type'=>'email'))?>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <?php
                    echo $this->Form->input('rol',array('options' => $roles,'default'=>$usuario->rol_id,
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <?php
                    echo $this->Form->input('empresa',array('options' => $empresas,'default'=>$usuario->id_empresa,
