...
/**
 * DetallesPedidosConsignacionFixture
 *
 */
class DetallesPedidosConsignacionFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'detalles_pedidos_consignacion';
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'detalles_pedidos_consignacion_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_pedido_venta'], 'references' => ['pedido_ventas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'detalles_pedidos_consignacion_ibfk_2' => ['type' => 'foreign', 'columns' => ['id_producto'], 'references' => ['productos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
