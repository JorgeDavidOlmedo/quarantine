...
class CalendarioFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'idbus' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'cantidad_dias_generados' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'fecha' => '2019-06-30',
            'periodo' => 1,
            'idbus' => 'Lorem ipsum dolor ',
            'id_ruta' => 1,
            'idempresa' => 1,
            'cantidad_dias_generados' => 1
        ],
    ];
}
