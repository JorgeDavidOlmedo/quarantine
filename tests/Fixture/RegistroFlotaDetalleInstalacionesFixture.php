...
/**
 * RegistroFlotaDetalleInstalacionesFixture
 *
 */
class RegistroFlotaDetalleInstalacionesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'id_instalacion_flota' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'istatus' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
