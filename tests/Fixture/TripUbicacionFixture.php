...
/**
 * TripUbicacionFixture
 *
 */
class TripUbicacionFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'google_map_coordenadas' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
