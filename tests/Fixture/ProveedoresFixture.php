...
class ProveedoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'codigo_interno' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => '0', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'documento' => ['type' => 'string', 'length' => 11, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'dv' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'id_plan_cuenta' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'descrip' => ['type' => 'index', 'columns' => ['descripcion'], 'length' => []],
            'docu' => ['type' => 'index', 'columns' => ['documento'], 'length' => []],
            'interno' => ['type' => 'index', 'columns' => ['codigo_interno'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'proveedores_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_empresa'], 'references' => ['empresas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'proveedores_ibfk_2' => ['type' => 'foreign', 'columns' => ['id_plan_cuenta'], 'references' => ['plan_de_cuentas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'documento' => 'Lorem ips',
            'dv' => 'Lorem ipsum dolor sit amet',
            'telefono' => 'Lorem ipsum dolor sit amet',
            'direccion' => 'Lorem ipsum dolor sit amet',
            'estado' => 1,
            'id_plan_cuenta' => 1,
            'fecha_nacimiento' => '2019-07-18',
            'created' => '2019-07-18 17:29:36',
            'modified' => 1563485376
        ],
    ];
}
